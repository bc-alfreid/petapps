class PetsController < ApplicationController
  ...
  def create
    ...
    @pet.user = current_user      # this will automatically save in pets table user id as user current id.
  ...
  private
    ...
    def pet_params
      params.require(:pet).permit(:name, :breed, :age, :size, :photo, :availability, :user_id, :picture)
    end
end
